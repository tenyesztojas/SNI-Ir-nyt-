...
export default async function MunkaltatoiRegPage() {
  ...
  if (existing) {
    const statusText: Record<string, string> = {
      ...
      approved: "A munkáltatói fiókod jóváhagyott. Hirdetést a Hirdetés feladása menüponton tudsz feladni.",
      rejected: "A regisztrációd sajnos elutasításra került. Vedd fel a kapcsolatot velünk.",
      suspended: "A munkáltatói fiókod felfüggesztve.",
    };
    return (
      <div className="mx-auto max-w-xl px-4 py-12 sm:px-6 text-center">
        <h1 className="text-xl font-bold text-sni-brand-navy">Munkáltatói státusz</h1>
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
      <h1 className="text-2xl font-extrabold text-sni-brand-navy">Munkáltatói regisztráció</h1>
      <p className="mt-2 text-sm text-gray-600">
        A regisztráció után admin jóváhagyást követően adhat fel hirdetést.
      </p>
