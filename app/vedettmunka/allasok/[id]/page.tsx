  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-sni-brand-navy/8 text-sni-brand-navy">
          <VmIcon name={icon} size={16} />
        </div>
                ...
                {selectionSteps.map((step, i) => (
                  <div key={step.key} className="flex items-start gap-3">
                    <div className="flex flex-col items-center">
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-sni-brand-teal/15 text-sni-brand-teal">
                        <VmIcon name={step.icon} size={14} />
                      </div>
