  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <Field name="support_description" label="" required as="textarea" rows={4}
        placeholder="Ez a kötelező Védett Karrier-mező. Írd le konkrétan, miben segít a munkakörnyezet: pl. van kijelölt mentor, a feladatokat írásban is megkapja, rugalmas a munkaidő, csendes irodai légkör, stb." />

      <hr className="my-1" />
      <p className="text-xs font-bold uppercase tracking-wide text-gray-400">Milyen ez a munkahely? (Védett Karrier kérdések)</p>
