'use client'
/**
 * Védett Karrier – Új munkakör form (Client Component)
 *
 * Csak szerver-oldali auth/authorization guard után renderelődik
 * (lásd: page.tsx).
 * A 'use client' direktíva kizárólag az interaktív form állapot kezelésére szükséges.
 */
...
export default function NewJobRoleClient() {
