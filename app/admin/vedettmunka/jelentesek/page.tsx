...
export const metadata = {
  title: "Admin – VédettKarrier jelentések",
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      <h1 className="mt-3 text-2xl font-bold text-sni-text">
        Hirdetés-jelentések ({reports.length})
      </h1>
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {statusOptions.map((s) => (
          <Link
            ...
            href={
              s
                ? `/admin/vedettmunka/jelentesek?status=${s}`
                : "/admin/vedettmunka/jelentesek"
            }
      ...
      <div className="mt-5 flex flex-col gap-4">
        ...
        {reports.map((r) => {
          const jobTitle =
            (r.job_posts as { title: string } | null)?.title ?? "–";
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 font-bold text-sni-brand-navy">
                    {jobTitle}
                  </p>
                  ...
                  <Link
                    href={`/vedettmunka/allasok/${r.job_id}`}
                    target="_blank"
