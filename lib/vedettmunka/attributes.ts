...
> = {
  ...
  jelentkezes_mod:  { label: "Jelentkezési mód",       emoji: "📨", color: "indigo" },
};
...
export const ATTRIBUTE_LABELS: Record<string, { title: string; desc: string }> = {
  ...
  written_tasks:        { title: "Írásban is megkapod a feladatot", desc: "A feladatokat írásban is megkaphatod." },

  // ── Munkakörnyezet ───────────────────────────────────────────
  quieter_env:          { title: "Csendes környezet",              desc: "A munkahely általában nem hangos." },
  ...
  uniform_provided:     { title: "Munkaruha biztosított",          desc: "A munkáltató biztosítja a szükséges munkaruhát." },
  safety_equipment:     { title: "Munkavédelmi eszközök biztosítottak", desc: "A szükséges munkavédelmi eszközöket a munkáltató adja." },
  ...
  // ── Helyszín ─────────────────────────────────────────────────
  onsite:               { title: "Munkahelyen",                    desc: "Minden nap egy meghatározott helyen dolgozol." },
  home_office:          { title: "Otthoni munkavégzés",            desc: "Otthonról is dolgozhatsz." },
  hybrid:               { title: "Munkavégzés otthon és munkahelyen", desc: "Részben otthonról, részben munkahelyen." },
  ...
  company_bus:          { title: "Céges busz",                     desc: "A munkáltató céges buszt biztosít a munkába járáshoz." },
  ...
  // ── Jelentkezési mód ─────────────────────────────────────────
  apply_cv:             { title: "Jelentkezés önéletrajzzal",      desc: "Önéletrajz beküldésével lehet jelentkezni." },
  apply_phone:          { title: "Telefonos jelentkezés",          desc: "Telefonon is lehet érdeklődni és jelentkezni." },
  apply_email:          { title: "E-mailes jelentkezés",           desc: "E-mailben lehet jelentkezni az állásra." },
};
...
export const WIZARD_STEP_ATTRIBUTES: Record<string, string[]> = {
  munkakornyzet: [
    ...
    "uniform_provided", "safety_equipment",
  ],
  betanitas: [
  ...
  megkozelites: ["accessible", "public_transport", "parking", "commute_support", "company_bus"],
  ...
  jelentkezes_mod: ["apply_cv", "apply_phone", "apply_email"],
};
